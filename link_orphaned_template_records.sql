/* SITE Linking orphaned template records and non templated activities to match against assigned templates */
...
and (a.asgnd_activity_detail_tmpl_id IS NULL
    OR (a.asgnd_activity_detail_tmpl_id is not null
        AND a.asgnd_activity_detail_tmpl_id NOT IN (select id from assigned_activity_detail_tmpl)))
and a.name=ad.name
and ad.type=a.type
